...
const ::uint32_t
    TableStruct_symbol_2eproto::offsets[] ABSL_ATTRIBUTE_SECTION_VARIABLE(
        ...
        ~0u,  // no _split_
        ~0u,  // no sizeof(Split)
        PROTOBUF_FIELD_OFFSET(::symbol::SymbolResponse, _impl_.found_),
        ...
        PROTOBUF_FIELD_OFFSET(::symbol::SymbolResponse, _impl_.quantity_precision_),
};
...
const char descriptor_table_protodef_symbol_2eproto[] ABSL_ATTRIBUTE_SECTION_VARIABLE(
    ...
    "\016\n\006symbol\030\001 \001(\t\"\215\001\n\016SymbolResponse\022\r\n\005fo"
    "und\030\001 \001(\010\022\016\n\006symbol\030\002 \001(\t\022\021\n\ttick_size\030\003"
    " \001(\001\022\024\n\014max_leverage\030\004 \001(\001\022\027\n\017price_prec"
    "ision\030\005 \001(\005\022\032\n\022quantity_precision\030\006 \001(\0052"
    "K\n\rSymbolService\022:\n\tGetSymbol\022\025.symbol.S"
    "ymbolRequest\032\026.symbol.SymbolResponseb\006pr"
    "oto3"
};
...
SymbolResponse::SymbolResponse(
  ...
  ::memcpy(reinterpret_cast<char *>(&_impl_) +
           ...
           reinterpret_cast<const char *>(&from._impl_) +
               offsetof(Impl_, tick_size_),
           offsetof(Impl_, quantity_precision_) -
               offsetof(Impl_, tick_size_) +
               sizeof(Impl_::quantity_precision_));
...
PROTOBUF_CONSTINIT PROTOBUF_ATTRIBUTE_INIT_PRIORITY1
const ::_pbi::TcParseTable<3, 6, 0, 36, 2> SymbolResponse::_table_ = {
  {
    0,  // no _has_bits_
    0, // no _extensions_
    ...
    // bool found = 1;
    {::_pbi::TcParser::SingularVarintNoZag1<bool, offsetof(SymbolResponse, _impl_.found_), 63>(),
     {8, 63, 0, PROTOBUF_FIELD_OFFSET(SymbolResponse, _impl_.found_)}},
    // string symbol = 2;
    {::_pbi::TcParser::FastUS1,
     {18, 63, 0, PROTOBUF_FIELD_OFFSET(SymbolResponse, _impl_.symbol_)}},
    // double tick_size = 3;
    {::_pbi::TcParser::FastF64S1,
     {25, 63, 0, PROTOBUF_FIELD_OFFSET(SymbolResponse, _impl_.tick_size_)}},
    ...
    {::_pbi::TcParser::SingularVarintNoZag1<::uint32_t, offsetof(SymbolResponse, _impl_.price_precision_), 63>(),
     {40, 63, 0, PROTOBUF_FIELD_OFFSET(SymbolResponse, _impl_.price_precision_)}},
    // int32 quantity_precision = 6;
    {::_pbi::TcParser::SingularVarintNoZag1<::uint32_t, offsetof(SymbolResponse, _impl_.quantity_precision_), 63>(),
     {48, 63, 0, PROTOBUF_FIELD_OFFSET(SymbolResponse, _impl_.quantity_precision_)}},
    {::_pbi::TcParser::MiniParse, {}},
  }}, {{
    65535, 65535
  }}, {{
    // bool found = 1;
    {PROTOBUF_FIELD_OFFSET(SymbolResponse, _impl_.found_), 0, 0,
    ...
    // int32 quantity_precision = 6;
    {PROTOBUF_FIELD_OFFSET(SymbolResponse, _impl_.quantity_precision_), 0, 0,
    (0 | ::_fl::kFcSingular | ::_fl::kInt32)},
  }},
  // no aux_entries
  {{
...
// @@protoc_insertion_point(message_clear_start:symbol.SymbolResponse)
  ...
  ::memset(&_impl_.tick_size_, 0, static_cast<::size_t>(
      reinterpret_cast<char*>(&_impl_.quantity_precision_) -
      reinterpret_cast<char*>(&_impl_.tick_size_)) + sizeof(_impl_.quantity_precision_));
  _internal_metadata_.Clear<::google::protobuf::UnknownFieldSet>();
}
        ...
        ::uint8_t* SymbolResponse::_InternalSerialize(
          ...
          if (::absl::bit_cast<::uint64_t>(this_._internal_tick_size()) != 0) {
            ...
            target = ::_pbi::WireFormatLite::WriteDoubleToArray(
                3, this_._internal_tick_size(), target);
          }
          ...
          // int32 quantity_precision = 6;
          if (this_._internal_quantity_precision() != 0) {
            target = ::google::protobuf::internal::WireFormatLite::
                WriteInt32ToArrayWithField<6>(
                    stream, this_._internal_quantity_precision(), target);
          }
          ...
          ::_pbi::Prefetch5LinesFrom7Lines(&this_);
           {
            ...
            if (this_._internal_quantity_precision() != 0) {
              total_size += ::_pbi::WireFormatLite::Int32SizePlusOne(
                  this_._internal_quantity_precision());
            }
          }
          return this_.MaybeComputeUnknownFieldsSize(total_size,
                                                     &this_._impl_._cached_size_);
...
void SymbolResponse::MergeImpl(::google::protobuf::MessageLite& to_msg, const ::google::protobuf::MessageLite& from_msg) {
  ...
  if (from._internal_quantity_precision() != 0) {
    _this->_impl_.quantity_precision_ = from._impl_.quantity_precision_;
  }
  _this->_internal_metadata_.MergeFrom<::google::protobuf::UnknownFieldSet>(from._internal_metadata_);
}
...
void SymbolResponse::InternalSwap(SymbolResponse* PROTOBUF_RESTRICT other) {
  ...
  ::google::protobuf::internal::memswap<
      PROTOBUF_FIELD_OFFSET(SymbolResponse, _impl_.quantity_precision_)
      + sizeof(SymbolResponse::_impl_.quantity_precision_)

...
/* @@protoc_insertion_point(class_definition:symbol.SymbolResponse) */ {
 ...
 public:
  ...
  enum : int {
    ...
    kQuoteCurrencyFieldNumber = 5,
    kBaseCurrencyFieldNumber = 6,
    kTickSizeFieldNumber = 2,
    kMaxLeverageFieldNumber = 4,
    kPricePrecisionFieldNumber = 3,
  };
  // string symbol = 1;
  void clear_symbol() ;
  ...
  template <typename Arg_ = const std::string&, typename... Args_>
  void set_quote_currency(Arg_&& arg, Args_... args);
  std::string* mutable_quote_currency();
  PROTOBUF_NODISCARD std::string* release_quote_currency();
  void set_allocated_quote_currency(std::string* value);

  private:
  const std::string& _internal_quote_currency() const;
  inline PROTOBUF_ALWAYS_INLINE void _internal_set_quote_currency(
      const std::string& value);
 ...
 private:
  ...
  struct Impl_ {
    ...
    ::google::protobuf::internal::ArenaStringPtr quote_currency_;
...
// string quote_currency = 5;
inline void SymbolResponse::clear_quote_currency() {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  _impl_.quote_currency_.ClearToEmpty();
}
inline const std::string& SymbolResponse::quote_currency() const
    ABSL_ATTRIBUTE_LIFETIME_BOUND {
  // @@protoc_insertion_point(field_get:symbol.SymbolResponse.quote_currency)
  return _internal_quote_currency();
}
template <typename Arg_, typename... Args_>
inline PROTOBUF_ALWAYS_INLINE void SymbolResponse::set_quote_currency(Arg_&& arg,
                                                     Args_... args) {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  _impl_.quote_currency_.Set(static_cast<Arg_&&>(arg), args..., GetArena());
  // @@protoc_insertion_point(field_set:symbol.SymbolResponse.quote_currency)
}
inline std::string* SymbolResponse::mutable_quote_currency() ABSL_ATTRIBUTE_LIFETIME_BOUND {
  std::string* _s = _internal_mutable_quote_currency();
  // @@protoc_insertion_point(field_mutable:symbol.SymbolResponse.quote_currency)
  return _s;
}
inline const std::string& SymbolResponse::_internal_quote_currency() const {
  ::google::protobuf::internal::TSanRead(&_impl_);
  return _impl_.quote_currency_.Get();
}
inline void SymbolResponse::_internal_set_quote_currency(const std::string& value) {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  _impl_.quote_currency_.Set(value, GetArena());
}
inline std::string* SymbolResponse::_internal_mutable_quote_currency() {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  return _impl_.quote_currency_.Mutable( GetArena());
}
inline std::string* SymbolResponse::release_quote_currency() {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  // @@protoc_insertion_point(field_release:symbol.SymbolResponse.quote_currency)
  return _impl_.quote_currency_.Release();
}
inline void SymbolResponse::set_allocated_quote_currency(std::string* value) {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  _impl_.quote_currency_.SetAllocated(value, GetArena());
  if (::google::protobuf::internal::DebugHardenForceCopyDefaultString() && _impl_.quote_currency_.IsDefault()) {
    _impl_.quote_currency_.Set("", GetArena());
  }
  // @@protoc_insertion_point(field_set_allocated:symbol.SymbolResponse.quote_currency)
}

// string base_currency = 6;
inline void SymbolResponse::clear_base_currency() {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  _impl_.base_currency_.ClearToEmpty();
}
inline const std::string& SymbolResponse::base_currency() const
    ABSL_ATTRIBUTE_LIFETIME_BOUND {
  // @@protoc_insertion_point(field_get:symbol.SymbolResponse.base_currency)
  return _internal_base_currency();
}
template <typename Arg_, typename... Args_>
inline PROTOBUF_ALWAYS_INLINE void SymbolResponse::set_base_currency(Arg_&& arg,
                                                     Args_... args) {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  _impl_.base_currency_.Set(static_cast<Arg_&&>(arg), args..., GetArena());
  // @@protoc_insertion_point(field_set:symbol.SymbolResponse.base_currency)
}
inline std::string* SymbolResponse::mutable_base_currency() ABSL_ATTRIBUTE_LIFETIME_BOUND {
  std::string* _s = _internal_mutable_base_currency();
  // @@protoc_insertion_point(field_mutable:symbol.SymbolResponse.base_currency)
  return _s;
}
inline const std::string& SymbolResponse::_internal_base_currency() const {
  ::google::protobuf::internal::TSanRead(&_impl_);
  return _impl_.base_currency_.Get();
}
inline void SymbolResponse::_internal_set_base_currency(const std::string& value) {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  _impl_.base_currency_.Set(value, GetArena());
}
inline std::string* SymbolResponse::_internal_mutable_base_currency() {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  return _impl_.base_currency_.Mutable( GetArena());
}
inline std::string* SymbolResponse::release_base_currency() {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  // @@protoc_insertion_point(field_release:symbol.SymbolResponse.base_currency)
  return _impl_.base_currency_.Release();
}
inline void SymbolResponse::set_allocated_base_currency(std::string* value) {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  ...
  // @@protoc_insertion_point(field_set_allocated:symbol.SymbolResponse.base_currency)
}
